#
# Module manifest for module 'Log4NetParse'
#
...
@{
  ...
  GUID = '11b87e1b-e74d-4c3c-a12b-18ce6eb1da33'
  ...
  Description = 'A module to parse log4net logs.'
  ...
  PrivateData = @{
    ...
    PSData = @{
      ...
      LicenseUri = 'https://github.com/HeyItsGilbert/Log4NetParse/blob/master/LICENSE'
  ...
  HelpInfoURI = 'https://heyitsgilbert.github.io/Log4NetParse/'
